...
public class RestaurantController {
    ...
    @GetMapping("/restaurant/{code}/discount")
    public ResponseEntity<List<Discount>> resDiscountList(@PathVariable int code){
        return ResponseEntity.status(HttpStatus.OK).body(discount.findByResCode(code));
    }
